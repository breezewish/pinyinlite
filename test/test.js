...
var symbolMap = require('../dev/symbolMap.js');
...
describe('pinyinlite()', function () {
  ...
  it('should support options.keepUnrecognized = false', function () {
    var expected = '/a//Q//zheng/zhuan///1/';
    var test = '《阿 Q 正传》_1。';
    var result = pinyinlite(test, {
      keepUnrecognized: false,
    });
    expected.split('/').forEach(function (pinyin, index) {
      if (pinyin === '') {
        result[index].should.be.empty();
  ...
  it('should support options.keepUnrecognized = true', function () {
    var expected = '《/a/ /Q/ /zheng/zhuan/》/_/1/。';
    var test = '《阿 Q 正传》_1。';
    var result = pinyinlite(test, {
